    ...
    return (
        <div className="container">
            <div className="header">
                ...
                <div className="botao">
                    <a href="https://jptechnologies.com.br/index.php/empresa/" className="links" id="sobre" target="_blank" rel="noopener noreferrer">Quem somos</a>
                    <a href="https://jptechnologies.com.br/index.php/contato/" className="links" id="contato" target="_blank" rel="noopener noreferrer">Contato</a>
